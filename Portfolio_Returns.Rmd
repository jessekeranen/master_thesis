...
data[, CROSS.SECT.MEAN := 0.007, by = Date]

test <- data[!is.na(RF.EXP.RET), 
        .(R2OOS = 1 - (sum((EXC.USD.RET - CROSS.SECT.MEAN)^2) / (sum(EXC.USD.RET^2))),
         TRAD.R2OOS = 1 - (sum((EXC.USD.RET - CROSS.SECT.MEAN)^2) / 
