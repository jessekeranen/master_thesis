...
# On balance volume
setorder(weekly_data, Date)
weekly_data[, OBV := cumsum(VO * sign(RET)), by = "Company"]
```
...
plot <- ggplot(number_of_companies, aes(Date, Count, color = Country)) + 
  geom_line() + theme_light() + theme(axis.title.y = element_blank(),
...
var <- c("RET", "BEME", "INV", "EP", "CA", "CTO", "CFP", "DEBT", "SP", "ROA",
         "ROE", "Q", "MOM7", "MOM12", "MOM36", "MOM2", "MOM.IND", "LOG.USD.MV", 
...
independend_variables <- c("CA", "CTO", "BEME", "CFP", "INV", "DEBT", "SP", "EP",
                           ...
                           "L.SD", "L.HIGH52.RATIO", "L.BETA", "L.IDVOL",
                           "L.LOG.USD.MV", "L.TO", "L.OBV")
