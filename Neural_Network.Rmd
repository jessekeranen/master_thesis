...
Neural network for illustration purposes. This part uses "neuralnet" function because it offers better visualization options than the one that is used for the actual return predictions. 
